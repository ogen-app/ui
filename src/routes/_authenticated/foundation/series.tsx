 ...
 * has produced — happens on a campaign's Foundation page, because that is the
 ...
 *
 * **Two gates, and this file only owns one.** `brand-materials` comes from the
 * Foundation layout above; `series` is checked here, because the section is
 * offered separately from the module it sits in (see `shown` in
 * `lib/brandSections`). With this flag off there is no card on the hub and no
 * route to reach directly — which is what "every entry point" asks for.
 *
