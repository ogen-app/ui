...
function CampaignLayout() {
  ...
  // Assets owns its whole page: its header carries an action that only means
    ...
    return (
      <PageContainer variant={'fullFlex'}>
        <div className={'h-0 grow overflow-y-auto flex flex-col'}>
          ...
          <div
            key={section}
            className={'page-content-motion px-3 lg:px-6 pt-4'}
          >
            <Outlet />
          </div>
        </div>
    ...
    <PageContainer variant={'fullFlex'}>
      <div className={'flex-1 min-h-0 flex flex-col'}>
        ...
        <div
          key={section}
          className={
            'page-content-motion grid overflow-hidden h-full px-3 lg:px-6'
          }
        >
          <Outlet />
        </div>
