 ...
 * render nothing — it must not *ask* for anything. The band sits on the
 * campaign's Foundation page, which is an ordinary screen people open all day,
 * so an unconditional query there would open a request for a section that
 * cannot be shown. Today the stub answers from `localStorage` and the cost is
