...
export function BrandOverview({
   ...
   *
   * A plain list rather than a `Fetched` like `sources`, for the reason `facts`
   * is one: it is read out of `localStorage` until the table exists, so it
   * cannot be in flight and cannot fail. It becomes a `Fetched` on the day it
   * becomes a fetch — see the `series` flag.
   *
